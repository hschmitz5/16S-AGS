...
output: 
  powerpoint_presentation:
    reference_doc: "Documents/4 Traditional White with Purple.pptx"  # optional, use a custom template if desired
---
...
# Temporarily disable knitr’s graphics device capturing
